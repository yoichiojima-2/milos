...
from milos import skills
from milos.errors import OptionsError
from milos.layout import skill_prefix
...
def test_parse_description_survives_a_truncated_read():
    """The CLI reads only the head of SKILL.md, so the closing --- may be gone."""
...
def test_parse_description_keeps_quotes_inside_a_quoted_scalar():
    ...
    # swallowing it would render é as a literal "u00e9" in the CLI
    assert skills.parse_description(b'---\ndescription: "caf\\u00e9 x"\n---\n') == r"caf\u00e9 x"
